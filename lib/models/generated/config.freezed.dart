...
@useResult
$Res call({
 String? locale,@JsonKey(fromJson: dashboardWidgetsSafeFormJson) List<DashboardWidget> dashboardWidgets, bool onlyStatisticsProxy, bool autoLaunch, bool silentLaunch, bool autoRun, bool openLogs, bool closeConnections, String testUrl, bool isAnimateToPage, bool autoCheckUpdate, bool showLabel, bool disclaimerAccepted, bool crashlyticsTip, bool crashlytics, bool minimizeOnExit, bool hidden, bool developerMode, RestoreStrategy restoreStrategy, bool showTrayTitle, bool autoStartOnMobileData, bool autoStopOnSpecificWifi, List<String> autoStopGatewayList
});
...
as bool,autoStartOnMobileData: null == autoStartOnMobileData ? _self.autoStartOnMobileData : autoStartOnMobileData // ignore: cast_nullable_to_non_nullable
as bool,autoStopOnSpecificWifi: null == autoStopOnSpecificWifi ? _self.autoStopOnSpecificWifi : autoStopOnSpecificWifi // ignore: cast_nullable_to_non_nullable
as bool,autoStopGatewayList: null == autoStopGatewayList ? _self.autoStopGatewayList : autoStopGatewayList // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? locale, @JsonKey(fromJson: dashboardWidgetsSafeFormJson)  List<DashboardWidget> dashboardWidgets,  bool onlyStatisticsProxy,  bool autoLaunch,  bool silentLaunch,  bool autoRun,  bool openLogs,  bool closeConnections,  String testUrl,  bool isAnimateToPage,  bool autoCheckUpdate,  bool showLabel,  bool disclaimerAccepted,  bool crashlyticsTip,  bool crashlytics,  bool minimizeOnExit,  bool hidden,  bool developerMode,  RestoreStrategy restoreStrategy,  bool showTrayTitle,  bool autoStartOnMobileData,  bool autoStopOnSpecificWifi,  List<String> autoStopGatewayList)  $default,) {final _that = this;
switch (_that) {
case _AppSettingProps():
return $default(_that.locale,_that.dashboardWidgets,_that.onlyStatisticsProxy,_that.autoLaunch,_that.silentLaunch,_that.autoRun,_that.openLogs,_that.closeConnections,_that.testUrl,_that.isAnimateToPage,_that.autoCheckUpdate,_that.showLabel,_that.disclaimerAccepted,_that.crashlyticsTip,_that.crashlytics,_that.minimizeOnExit,_that.hidden,_that.developerMode,_that.restoreStrategy,_that.showTrayTitle,_that.autoStartOnMobileData,_that.autoStopOnSpecificWifi,_that.autoStopGatewayList);case _:
  throw StateError('Unexpected subclass');
...
class _AppSettingProps implements AppSettingProps {
  const _AppSettingProps({this.locale, @JsonKey(fromJson: dashboardWidgetsSafeFormJson) final  List<DashboardWidget> dashboardWidgets = defaultDashboardWidgets, this.onlyStatisticsProxy = false, this.autoLaunch = false, this.silentLaunch = false, this.autoRun = false, this.openLogs = false, this.closeConnections = true, this.testUrl = defaultTestUrl, this.isAnimateToPage = true, this.autoCheckUpdate = true, this.showLabel = false, this.disclaimerAccepted = false, this.crashlyticsTip = false, this.crashlytics = false, this.minimizeOnExit = true, this.hidden = false, this.developerMode = false, this.restoreStrategy = RestoreStrategy.compatible, this.showTrayTitle = true, this.autoStartOnMobileData = false, this.autoStopOnSpecificWifi = false, final  List<String> autoStopGatewayList = const []}): _dashboardWidgets = dashboardWidgets,_autoStopGatewayList = autoStopGatewayList;
...
@override@JsonKey() final  bool autoStartOnMobileData;
@override@JsonKey() final  bool autoStopOnSpecificWifi;
 final  List<String> _autoStopGatewayList;
@override@JsonKey() List<String> get autoStopGatewayList {
  if (_autoStopGatewayList is EqualUnmodifiableListView) return _autoStopGatewayList;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_autoStopGatewayList);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AppSettingProps&&(identical(other.locale, locale) || other.locale == locale)&&const DeepCollectionEquality().equals(other._dashboardWidgets, _dashboardWidgets)&&(identical(other.onlyStatisticsProxy, onlyStatisticsProxy) || other.onlyStatisticsProxy == onlyStatisticsProxy)&&(identical(other.autoLaunch, autoLaunch) || other.autoLaunch == autoLaunch)&&(identical(other.silentLaunch, silentLaunch) || other.silentLaunch == silentLaunch)&&(identical(other.autoRun, autoRun) || other.autoRun == autoRun)&&(identical(other.openLogs, openLogs) || other.openLogs == openLogs)&&(identical(other.closeConnections, closeConnections) || other.closeConnections == closeConnections)&&(identical(other.testUrl, testUrl) || other.testUrl == testUrl)&&(identical(other.isAnimateToPage, isAnimateToPage) || other.isAnimateToPage == isAnimateToPage)&&(identical(other.autoCheckUpdate, autoCheckUpdate) || other.autoCheckUpdate == autoCheckUpdate)&&(identical(other.showLabel, showLabel) || other.showLabel == showLabel)&&(identical(other.disclaimerAccepted, disclaimerAccepted) || other.disclaimerAccepted == disclaimerAccepted)&&(identical(other.crashlyticsTip, crashlyticsTip) || other.crashlyticsTip == crashlyticsTip)&&(identical(other.crashlytics, crashlytics) || other.crashlytics == crashlytics)&&(identical(other.minimizeOnExit, minimizeOnExit) || other.minimizeOnExit == minimizeOnExit)&&(identical(other.hidden, hidden) || other.hidden == hidden)&&(identical(other.developerMode, developerMode) || other.developerMode == developerMode)&&(identical(other.restoreStrategy, restoreStrategy) || other.restoreStrategy == restoreStrategy)&&(identical(other.showTrayTitle, showTrayTitle) || other.showTrayTitle == showTrayTitle)&&(identical(other.autoStartOnMobileData, autoStartOnMobileData) || other.autoStartOnMobileData == autoStartOnMobileData)&&(identical(other.autoStopOnSpecificWifi, autoStopOnSpecificWifi) || other.autoStopOnSpecificWifi == autoStopOnSpecificWifi)&&const DeepCollectionEquality().equals(other._autoStopGatewayList, _autoStopGatewayList));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,locale,const DeepCollectionEquality().hash(_dashboardWidgets),onlyStatisticsProxy,autoLaunch,silentLaunch,autoRun,openLogs,closeConnections,testUrl,isAnimateToPage,autoCheckUpdate,showLabel,disclaimerAccepted,crashlyticsTip,crashlytics,minimizeOnExit,hidden,developerMode,restoreStrategy,showTrayTitle,autoStartOnMobileData,autoStopOnSpecificWifi,const DeepCollectionEquality().hash(_autoStopGatewayList)]);
...
as bool,autoStartOnMobileData: null == autoStartOnMobileData ? _self.autoStartOnMobileData : autoStartOnMobileData // ignore: cast_nullable_to_non_nullable
as bool,autoStopOnSpecificWifi: null == autoStopOnSpecificWifi ? _self.autoStopOnSpecificWifi : autoStopOnSpecificWifi // ignore: cast_nullable_to_non_nullable
as bool,autoStopGatewayList: null == autoStopGatewayList ? _self._autoStopGatewayList : autoStopGatewayList // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
